...
La costruzione sintattica degli argomenti ruota sulla \emph{struttura tematica} degli argomenti, così che in italiano una costruzione transitiva può presentare:

\begin{itemize}
\tightlist
\item
  Un soggetto AGENTE e un oggetto PAZIENTE/TEMA
\item
  Un soggetto AGENTE e un oggetto DESTINATARIO
\item
  Un soggetto DESTINATARIO e un oggetto TEMA
\item
  Un soggetto ESPERIENTE e un oggetto TEMA
\end{itemize}

In questo modo possiamo definire gli argomenti nucleari di una frase quelli che presentano un tratto tematico, mentre i circostanziali non hanno tratti tematici associati.

\hypertarget{la-nozione-di-movimento}{%
\subsection{La nozione di movimento}\label{la-nozione-di-movimento}}

\hypertarget{esempi-di-movimento}{%
\subsubsection{Esempi di movimento}\label{esempi-di-movimento}}

\hypertarget{frasi-semplici-nominali}{%
\subsection{Frasi semplici nominali}\label{frasi-semplici-nominali}}

\hypertarget{la-frase-complessa}{%
\section{La frase complessa}\label{la-frase-complessa}}

\hypertarget{coordinazione-giustapposizione-subordinazione}{%
\subsection{Coordinazione, giustapposizione, subordinazione}\label{coordinazione-giustapposizione-subordinazione}}
