...
Possiamo dividere queste unità all'interno di parentesi quadre, così da mostrare i rapporti sintattici:
...
Uno studente attento potrebbe notare qualche differente rispetto ad una notazione ad albero precedente:
...
La prima è più semplice differenza che possiamo notare è nella denominazione dei sintagmi: il primo albero presenta una notazione inglese, mentre il secondo in italiano. Così \emph{Determiner Phrase} (DP) corrisponde grosso modo a SN, mentre il sintagma verbale (SV) si compone di diversi livelli (VP, vP, TP), che corrispondono alla radice verbale V, al sintagma v (che possiamo dire legato alla transitività -ma v è un po' problematico) ed a quello di tempo finito T.
