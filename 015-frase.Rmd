...
La prima è più semplice differenza che possiamo notare è nella denominazione dei sintagmi: il primo albero presenta una notazione inglese, mentre il secondo in italiano.  Così *Determiner Phrase* (DP) corrisponde grosso modo a SN, mentre il sintagma verbale (SV) si compone di diversi livelli (VP, vP, TP), che corrispondono all'unione della radice verbale V, al sintagma v (che possiamo dire legato alla transitività -ma v è un po' problematico) ed a quello di tempo finito T.

### Le proprietà della sintassi

Le differenze tra questi due sistemi di visualizzazioni derivano però da un'importante rivisitazione teorica.
